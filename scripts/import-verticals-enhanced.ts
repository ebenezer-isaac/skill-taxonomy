 ...
 *
 * Curated, domain-specific skills across ALL industries —
 * not just tech verticals.
 *
 * Verticals:
...
const VERTICALS: Record<string, VerticalDefinition> = {
  ...
  'hr-people': {
    ...
    skills: [
      ['workday', 'workday hcm'],
      ['bamboohr', 'bamboo hr'],
      ['greenhouse recruiting', 'greenhouse ats'],
      ['lever recruiting', 'lever ats'],
      ['icims', 'icims ats'],
      ['ukg', 'ultimate kronos group', 'kronos'],
      ...
      ['employee onboarding', 'onboarding program'],
      ['performance management', 'performance review'],
      ['compensation planning', 'comp planning', 'salary benchmarking'],
      ['benefits administration', 'benefits management'],
      ['workforce planning', 'headcount planning'],
      ['succession planning', 'talent pipeline'],
      ['organizational development', 'od'],
      ['labor relations', 'employee relations', 'union relations'],
      ['diversity equity inclusion', 'dei', 'd&i'],
      ['employee engagement', 'engagement survey'],
      ['people analytics', 'hr analytics', 'workforce analytics'],
      ['job evaluation', 'hay methodology', 'job grading'],
      ['employer branding', 'evp', 'employer value proposition'],
  ...
  'accounting-finance': {
    ...
    description: 'Bookkeeping, tax, audit, and corporate finance',
    skills: [
      ['quickbooks', 'quickbooks online', 'qbo'],
      ['sage intacct', 'sage 50', 'sage accounting'],
      ['xero', 'xero accounting'],
      ['netsuite', 'oracle netsuite'],
      ['freshbooks', 'fresh books'],
      ...
      ['financial close', 'month-end close', 'year-end close'],
      ...
      ['cash flow forecasting', 'cash flow management'],
    ],
  },

  construction: {
    name: 'Construction & Architecture',
    description: 'Building construction, civil engineering, and architecture',
    skills: [
      ['autocad', 'auto cad', 'autocad civil 3d'],
      ['revit', 'autodesk revit', 'revit architecture'],
      ['building information modeling', 'bim', 'bim 360'],
      ...
      ['archicad', 'archi cad'],
      ['sketchup', 'sketch up', 'sketchup pro'],
      ['enscape', 'enscape 3d'],
      ['lumion', 'lumion 3d'],
      ['rhino', 'rhinoceros 3d'],
      ...
      ['cost estimation', 'quantity surveying', 'construction estimating'],
      ['project scheduling', 'critical path method', 'cpm'],
      ['osha compliance', 'construction safety', 'safety management'],
      ['structural analysis', 'structural engineering'],
      ['geotechnical engineering', 'soil mechanics'],
      ['surveying', 'land surveying', 'topographic survey'],
      ['concrete technology', 'concrete mix design'],
      ['steel fabrication', 'steel detailing'],
      ['hvac design', 'mechanical engineering'],
      ['mep coordination', 'mechanical electrical plumbing'],
      ['stormwater management', 'drainage design'],
      ['leed certification', 'green building', 'sustainable design'],
      ['value engineering', 've'],
      ['contract administration', 'construction contracts'],
      ['punch list', 'deficiency list', 'snag list'],
    ],
  },

  education: {
    name: 'Education & Training',
    description: 'Teaching, curriculum development, educational technology, and research',
    skills: [
      ['canvas lms', 'canvas learning management'],
      ['blackboard', 'blackboard learn'],
      ['moodle', 'moodle lms'],
      ['google classroom', 'google education'],
      ['schoology', 'schoology lms'],
      ['d2l brightspace', 'brightspace', 'd2l'],
      ['edmodo', 'edmodo platform'],
      ['nearpod', 'nearpod lessons'],
      ['kahoot', 'kahoot quizzes'],
      ['turnitin', 'turn it in'],
      ...
      ['instructional design', 'learning design', 'addie model'],
      ['bloom taxonomy', 'learning objectives'],
      ['formative assessment', 'summative assessment'],
      ['differentiated instruction', 'differentiation'],
      ['special education', 'sped', 'individualized education program', 'iep'],
  ...
  manufacturing: {
    ...
    description: 'Production, process engineering, quality control, and industrial automation',
    skills: [
      ['siemens nx', 'nx cad/cam'],
      ['mastercam', 'master cam'],
      ['ansys', 'ansys simulation'],
      ['abaqus', 'abaqus fea'],
      ['solidworks simulation', 'solidworks fea'],
      ['catia', 'dassault catia'],
      ['creo', 'ptc creo', 'pro/engineer'],
      ['labview', 'lab view', 'national instruments labview'],
      ['matlab', 'matlab simulink'],
      ['minitab', 'minitab statistical'],
      ['plc programming', 'programmable logic controller'],
      ['scada', 'supervisory control and data acquisition'],
      ['siemens tia portal', 'tia portal'],
      ['allen-bradley', 'rockwell automation', 'rslogix'],
      ['wonderware', 'aveva wonderware'],
      ['fanuc', 'fanuc robotics'],
      ['kuka', 'kuka robotics'],
      ['abb robotics', 'abb robots'],
      ['cnc machining', 'cnc programming', 'g-code'],
      ['injection molding', 'plastic injection'],
      ['lean manufacturing', 'lean production', 'toyota production system'],
      ...
      ['production planning', 'production scheduling', 'mrp'],
      ['bill of materials', 'bom', 'bom management'],
  ...
  marketing: {
    ...
    description: 'Brand management, digital advertising, content, SEO, and analytics',
    skills: [
      ...
      ['hotjar', 'hot jar', 'heatmap analytics'],
      ...
      ['marketing automation', 'marketing ops'],
  ...
  sales: {
    ...
    skills: [
      ...
      ['hubspot sales hub', 'hubspot sales'],
      ['pipedrive', 'pipe drive'],
      ['zoho crm', 'zoho sales'],
      ['outreach', 'outreach.io'],
      ['salesloft', 'sales loft'],
      ['gong', 'gong.io', 'revenue intelligence'],
      ['chorus', 'zoominfo chorus'],
      ['linkedin sales navigator', 'sales nav'],
      ['clari', 'clari revenue'],
      ['zoominfo', 'zoom info'],
      ['docusign', 'docu sign', 'e-signature'],
      ['conga', 'conga cpq'],
  ...
  'real-estate': {
    ...
    description: 'Property management, appraisal, brokerage, and investment',
    skills: [
      ['yardi', 'yardi voyager', 'yardi breeze'],
      ['appfolio', 'app folio'],
      ['realpage', 'real page'],
      ['buildium', 'buildium pm'],
      ['mri software', 'mri real estate'],
      ['costar', 'costar group'],
      ['argus', 'argus enterprise', 'argus dcf'],
      ['reonomy', 'reonomy data'],
      ['mls', 'multiple listing service'],
      ['zillow', 'zillow premier agent'],
      ['property management', 'real estate management'],
      ['real estate appraisal', 'property valuation'],
      ['commercial real estate', 'cre'],
      ['leasing', 'lease administration'],
      ['tenant management', 'tenant relations'],
      ...
      ['rent roll', 'rent analysis'],
    ],
  },

  'agriculture': {
    name: 'Agriculture & Food Production',
    description: 'Farming, precision agriculture, food processing, and food safety',
    skills: [
      ['john deere operations center', 'john deere stellus'],
      ['trimble agriculture', 'trimble ag'],
      ['climate fieldview', 'climate corporation'],
      ['ag leader', 'ag leader technology'],
      ['granular', 'granular farm management'],
      ['farmers edge', 'farmers edge platform'],
      ['agworld', 'ag world'],
      ['precision agriculture', 'precision farming'],
      ['gps guidance', 'auto-steer', 'rtk gps'],
      ['variable rate technology', 'vrt', 'variable rate application'],
      ['agronomy', 'crop science', 'crop management'],
      ['soil science', 'soil analysis', 'soil testing'],
      ['irrigation management', 'drip irrigation', 'pivot irrigation'],
      ['pest management', 'ipm', 'integrated pest management'],
      ['crop rotation', 'cover cropping'],
      ['livestock management', 'herd management', 'animal husbandry'],
      ['dairy management', 'dairy farming'],
  ...
  energy: {
    ...
    description: 'Power generation, renewables, oil & gas, and grid management',
    skills: [
      ['etap', 'electrical transient analyzer program'],
      ['pss/e', 'power system simulator'],
      ['digsilent', 'powerfactory'],
      ['pvsyst', 'pv syst', 'solar simulation'],
      ['homer energy', 'homer pro'],
      ['aspen hysys', 'hysys process simulation'],
      ['petrel', 'schlumberger petrel'],
      ['eclipse', 'eclipse reservoir simulator'],
      ['openworks', 'landmark openworks'],
      ['osisoft pi', 'pi system', 'osisoftpi'],
      ['aveva', 'aveva e3d'],
      ['power generation', 'power plant operations'],
      ['renewable energy', 'clean energy'],
      ['solar energy', 'photovoltaic', 'solar panel design'],
      ['wind energy', 'wind farm', 'wind turbine'],
      ['energy storage', 'battery storage', 'bess'],
      ['smart grid', 'grid modernization'],
      ['scada', 'energy scada', 'grid scada'],
      ['power distribution', 'distribution engineering'],
      ['transmission engineering', 'high voltage'],
      ['drilling engineering', 'well engineering'],
      ['reservoir engineering', 'reservoir simulation'],
      ['pipeline engineering', 'pipeline integrity'],
      ['process safety', 'process safety management', 'psm'],
      ['energy trading', 'power trading'],
      ['nerc compliance', 'nerc cip'],
      ['ferc regulations', 'energy regulation'],
      ['environmental impact assessment', 'eia'],
      ['carbon accounting', 'carbon footprint', 'ghg emissions'],
    ],
  },

  hospitality: {
    name: 'Hospitality & Tourism',
    description: 'Hotel management, food service, tourism, and events',
    skills: [
      ['opera pms', 'oracle opera', 'opera cloud'],
      ['micros pos', 'oracle micros'],
      ['toast pos', 'toast restaurant'],
      ['square pos', 'square for restaurants'],
      ['aloha pos', 'ncr aloha'],
      ['lightspeed pos', 'lightspeed restaurant'],
      ['opentable', 'open table'],
      ['resy', 'resy reservations'],
      ['revinate', 'revinate marketing'],
      ['str', 'smith travel research'],
      ['hotel management', 'hospitality management'],
      ['revenue management', 'yield management', 'revpar'],
      ['food and beverage', 'f&b management'],
      ['front office management', 'front desk operations'],
      ['housekeeping management', 'rooms division'],
      ['banquet management', 'catering management'],
      ['guest experience', 'guest satisfaction'],
      ['adr', 'average daily rate'],
      ['occupancy rate', 'occupancy management'],
      ['food cost control', 'food cost management'],
      ['menu engineering', 'menu design'],
      ['server training', 'hospitality training'],
      ['starcertification', 'hotel classification'],
      ['tourism management', 'destination management'],
      ['event coordination', 'event management', 'conference management'],
  ...
  government: {
    ...
    description: 'Public policy, civic technology, and government operations',
    skills: [
      ...
      ['urban planning', 'city planning', 'zoning'],
      ...
      ['constituent services', 'citizen engagement'],
      ['government contracting', 'federal contracting', 'govcon'],
  ...
  'media-journalism': {
    ...
    description: 'News, broadcasting, content production, and publishing',
    skills: [
      ['adobe premiere pro', 'premiere', 'premiere pro'],
      ['final cut pro', 'final cut', 'fcpx'],
      ['davinci resolve', 'davinci', 'blackmagic resolve'],
      ...
      ['cinema 4d', 'c4d', 'maxon cinema 4d'],
      ['blender', 'blender 3d'],
      ['obs studio', 'obs', 'open broadcaster'],
      ['journalism', 'news reporting', 'investigative journalism'],
      ['broadcast journalism', 'television news', 'tv production'],
      ['photojournalism', 'press photography'],
      ['audio production', 'podcast production'],
      ['video production', 'videography'],
      ['live streaming', 'live broadcast'],
      ['ap style', 'associated press style'],
      ['fact-checking', 'fact verification'],
      ['newsroom management', 'editorial management'],
      ['content management system', 'cms'],
      ['audience development', 'audience engagement'],
      ['media ethics', 'journalism ethics'],
      ['digital publishing', 'online publishing'],
      ['multimedia storytelling', 'data journalism'],
    ],
  },

  'environmental': {
    name: 'Environmental & Sustainability',
    description: 'Environmental science, ESG, sustainability, and conservation',
    skills: [
      ['arcgis', 'esri arcgis'],
      ['qgis', 'quantum gis'],
      ['envi', 'l3harris envi'],
      ['environmental impact assessment', 'eia', 'nepa'],
      ['environmental remediation', 'site remediation'],
      ['hazardous waste management', 'hazmat'],
      ['water quality management', 'water treatment'],
      ['air quality monitoring', 'emissions monitoring'],
      ['iso 14001', 'environmental management system'],
      ['esg reporting', 'esg', 'environmental social governance'],
      ['sustainability reporting', 'gri', 'global reporting initiative'],
      ['carbon footprint', 'carbon accounting', 'ghg protocol'],
      ['life cycle assessment', 'lca'],
      ['circular economy', 'waste reduction'],
      ['biodiversity assessment', 'ecological survey'],
      ['wetland delineation', 'wetland assessment'],
      ['phase i esa', 'environmental site assessment'],
      ['stormwater management', 'npdes'],
      ['sustainability strategy', 'corporate sustainability'],
      ['climate risk', 'climate adaptation'],
      ['renewable energy certificates', 'rec', 'green certificates'],
  ...
  telecommunications: {
    ...
    description: 'Network engineering, wireless, fiber optics, and telecom operations',
    skills: [
      ['5g', '5g nr', 'fifth generation'],
      ['lte', 'lte-advanced', '4g lte'],
      ['fiber optics', 'ftth', 'fiber to the home'],
      ['voip', 'voice over ip', 'sip'],
      ['mpls', 'multiprotocol label switching'],
      ['sd-wan', 'software-defined wan'],
      ['bgp', 'border gateway protocol'],
      ['ospf', 'open shortest path first'],
      ['rf engineering', 'radio frequency'],
      ['antenna design', 'antenna engineering'],
      ...
      ['nokia nsp', 'nokia network services'],
      ['ericsson', 'ericsson telecom'],
      ['billing system', 'telecom billing'],
      ['number portability', 'mnp'],
      ['spectrum management', 'frequency planning'],
      ['tower management', 'cell site management'],
    ],
  },
};
